...
web_server    = 'http://172.30.1.44:8080'

get_names_cgi = '/cgi-bin/generate_names_sqlite3.py'
get_data_cgi  = '/cgi-bin/generate_data_sqlite3.py'
...
if resp['which'] in ('positive'):
    ...
    if resp['which'] in ('positive'):
        ...
        add_time_cgi = '/cgi-bin/add_timing_data_sqlite3.py'
