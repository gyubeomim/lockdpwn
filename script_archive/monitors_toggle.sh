...
case $1 in
    ...
    atlas1)
		# 다중 모니터 ON
       xrandr --output DVI-I-1 --mode 1920x1080 --pos 0x0 --output HDMI-1 --mode 1920x1080 --pos 1920x0 --primary
    ...
    off_atlas1)
		# 1개 모니터만 켠다 
       xrandr --output DVI-D-1 --primary --mode 1920x1080 --pos 0x0  --output DVI-I-1 --off --output HDMI-0 --off
        ;;
esac
