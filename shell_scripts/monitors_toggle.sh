...
case $1 in
    off)
       # 중앙 모니터만 ON 나머지는 OFF
       xrandr --output eDP1 --off --output VGA1 --mode 1920x1080R --off --output HDMI1 --pos 0x0 --scale 1.0x1.0
        ;;
    three1)
    ...
    atlas1)
		# 다중 모니터 ON
       xrandr --output DVI-D-0 --mode 2560x1440 --pos 0x0 --primary --output DVI-I-1 --mode 2560x1440 --pos 2560x0
    ...
    off_atlas1)
		# 1개 모니터만 켠다 
       xrandr --output DVI-D-0 --primary --mode 2560x1440 --pos 0x0  --output DVI-I-1 --off 
        ;;
esac
