/*
 * #+DESCRIPTION:  백준 5052, 전화번호 목록 문제를 푼 정답 코드
 * #+CATEGORY:     TRIE
 * #+LEVEL:        -
 * #+FROM:         http://blog.naver.com/PostView.nhn?blogId=kks227&logNo=220576143081&parentCategoryNo=271&categoryNo=303&viewDate=&isShowPopularPosts=false&from=postList
 * #+DATE:         2018-06-10-일
