/*
	c++ ==> opencv, ga.jpg를 격자단위로 구분한 다음 점을 찍어보고 선을 그어본 예제 코드 
				https://github.com/jponttuset/sudoku/blob/master/sudoku_ar_solver.cpp	소스코드 참조
*/
/* Basic includes */
#include <iostream>
#include <stdio.h>
...
// 여러개의 교차선에서 실제 Grid 부분을 찾아주는 함수
// 실제 교차선은 많은 부분이 겹치게 되므로 이를 판단하는 코드인듯
...
int main(int argc, const char *argv[]) {
	...
	*/
	...
	if (good1 || good2)
	{
		// 데이터의 grid 코너에 빨간색 점을 그려주는 코드
		// 아마 정사각형일 때 작동하는 듯 하다 위 코드를 봐선 good1 && good2 였음
		// sudoku.jpg 파일은 정상적으로 인식한다
