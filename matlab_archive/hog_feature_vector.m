% matlab ==> ºñÁÖ¾óÄÄÇ»ÆÃ, »ç¶÷ ÀÎ½Ä ÇÊÅÍÀÎ hog Feature¸¦ matlabÀ¸·Î ±¸ÇöÇÑ ÄÚµå
...
% ê²°ê³¼?ìœ¼ë¡?êµ¬í•´?¼í•˜??ë³?ˆ˜??angle, magnitude
...
for i = 0: rows/8 - 2
    for j= 0: cols/8 -2
		...
		% ê°ê°??ë¸”ë¡?ì„œ ?˜ì˜¤??9ê°œì˜ bin?¤ì„ 1x9ì§œë¦¬ ?ˆìŠ¤? ê·¸?¨ìœ¼ë¡?2ì°¨ì› ë°°ì—´ë¡???ž¥?œë‹¤
		% ?„ì²˜?¼í•˜ê³?TF???£ìœ¼ë©??™ìŠµ???˜ëœ??
