...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/mylab2_simulink_to_ros.elf
...
MODELREF_LINK_RSPFILE_NAME = mylab2_simulink_to_ros_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/mylab2_simulink_to_ros.elf
