  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2015481221U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4148254475U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3496197723U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(869932091U);
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1347717545U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3724370354U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2775433921U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4251393421U);
  }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(aiChksum, "fIJGlazxe8VrRpJ0aB9CEE") == 0) {
          extern mxArray
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "73GtgSCpIdTS6krzWCmk3E") == 0) {
  ...
  debugInstance)
{
  _vehicle_longitudinal_modelMachineNumber_ = sf_debug_initialize_machine
    (debugInstance,"vehicle_longitudinal_model","sfun",0,1,0,0,0);
