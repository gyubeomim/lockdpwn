...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2679370367U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1991565153U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2139233939U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4057883462U);
}
...
mxArray *sf_c1_vehicle_longitudinal_model_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("fIJGlazxe8VrRpJ0aB9CEE");
...
static void mdlSetWorkWidths_c1_vehicle_longitudinal_model(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(793401634U));
  ssSetChecksum1(S,(2077222897U));
  ssSetChecksum2(S,(2680841433U));
  ssSetChecksum3(S,(393853950U));
