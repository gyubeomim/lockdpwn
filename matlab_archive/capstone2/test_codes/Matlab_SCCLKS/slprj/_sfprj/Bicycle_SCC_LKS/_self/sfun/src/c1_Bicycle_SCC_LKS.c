...
static void initialize_c1_Bicycle_SCC_LKS(SFc1_Bicycle_SCC_LKSInstanceStruct
  *chartInstance);
static void initialize_params_c1_Bicycle_SCC_LKS
  (SFc1_Bicycle_SCC_LKSInstanceStruct *chartInstance);
static void enable_c1_Bicycle_SCC_LKS(SFc1_Bicycle_SCC_LKSInstanceStruct
  *chartInstance);
static void disable_c1_Bicycle_SCC_LKS(SFc1_Bicycle_SCC_LKSInstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_Bicycle_SCC_LKS
  (SFc1_Bicycle_SCC_LKSInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_Bicycle_SCC_LKS
  (SFc1_Bicycle_SCC_LKSInstanceStruct *chartInstance);
static void set_sim_state_c1_Bicycle_SCC_LKS(SFc1_Bicycle_SCC_LKSInstanceStruct *
  chartInstance, const mxArray *c1_st);
static void c1_set_sim_state_side_effects_c1_Bicycle_SCC_LKS
  (SFc1_Bicycle_SCC_LKSInstanceStruct *chartInstance);
static void finalize_c1_Bicycle_SCC_LKS(SFc1_Bicycle_SCC_LKSInstanceStruct
  *chartInstance);
static void sf_gateway_c1_Bicycle_SCC_LKS(SFc1_Bicycle_SCC_LKSInstanceStruct
  *chartInstance);
static void c1_chartstep_c1_Bicycle_SCC_LKS(SFc1_Bicycle_SCC_LKSInstanceStruct
  *chartInstance);
static void initSimStructsc1_Bicycle_SCC_LKS(SFc1_Bicycle_SCC_LKSInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_Bicycle_SCC_LKSInstanceStruct
  *chartInstance, const mxArray *c1_nargout, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_Bicycle_SCC_LKSInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static boolean_T c1_c_emlrt_marshallIn(SFc1_Bicycle_SCC_LKSInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_d_emlrt_marshallIn(SFc1_Bicycle_SCC_LKSInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_Bicycle_SCC_LKSInstanceStruct
  *chartInstance, const mxArray *c1_b_tp_Cruise_Mode, const char_T
  *c1_identifier);
static uint8_T c1_f_emlrt_marshallIn(SFc1_Bicycle_SCC_LKSInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_g_emlrt_marshallIn(SFc1_Bicycle_SCC_LKSInstanceStruct
  *chartInstance, const mxArray *c1_b_setSimStateSideEffectsInfo, const char_T
  *c1_identifier);
static const mxArray *c1_h_emlrt_marshallIn(SFc1_Bicycle_SCC_LKSInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_updateDataWrittenToVector(SFc1_Bicycle_SCC_LKSInstanceStruct
  *chartInstance, uint32_T c1_vectorIndex);
static void c1_errorIfDataNotWrittenToFcn(SFc1_Bicycle_SCC_LKSInstanceStruct
  *chartInstance, uint32_T c1_vectorIndex, uint32_T c1_dataNumber);
static void init_dsm_address_info(SFc1_Bicycle_SCC_LKSInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_Bicycle_SCC_LKS = 0U;
  chartInstance->c1_is_c1_Bicycle_SCC_LKS = c1_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc1_Bicycle_SCC_LKSInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_c1_Bicycle_SCC_LKS == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
  }

  if (chartInstance->c1_is_c1_Bicycle_SCC_LKS == c1_IN_Cruise_Mode) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
  }

  if (chartInstance->c1_is_c1_Bicycle_SCC_LKS == c1_IN_FollowUp_Mode) {
  ...
  (SFc1_Bicycle_SCC_LKSInstanceStruct *chartInstance)
{
  ...
  c1_c_hoistedGlobal = chartInstance->c1_is_active_c1_Bicycle_SCC_LKS;
  c1_c_u = c1_c_hoistedGlobal;
  c1_d_y = NULL;
  sf_mex_assign(&c1_d_y, sf_mex_create("y", &c1_c_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c1_y, 2, c1_d_y);
  c1_d_hoistedGlobal = chartInstance->c1_is_c1_Bicycle_SCC_LKS;
  ...
  chartInstance, const mxArray *c1_st)
{
  ...
  *c1_SetSpd = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u,
  ...
  chartInstance->c1_is_active_c1_Bicycle_SCC_LKS = c1_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
     "is_active_c1_Bicycle_SCC_LKS");
  chartInstance->c1_is_c1_Bicycle_SCC_LKS = c1_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 3)), "is_c1_Bicycle_SCC_LKS");
  sf_mex_assign(&chartInstance->c1_setSimStateSideEffectsInfo,
                c1_g_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c1_u, 4)), "setSimStateSideEffectsInfo"), true);
  sf_mex_destroy(&c1_u);
  chartInstance->c1_doSetSimStateSideEffects = 1U;
  c1_update_debugger_state_c1_Bicycle_SCC_LKS(chartInstance);
  ...
  *chartInstance)
{
  ...
  c1_set_sim_state_side_effects_c1_Bicycle_SCC_LKS(chartInstance);
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_Bicycle_SCC_LKS(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_Bicycle_SCC_LKSMachineNumber_,
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_c1_Bicycle_SCC_LKS == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_active_c1_Bicycle_SCC_LKS = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 2U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_c1_Bicycle_SCC_LKS = c1_IN_Cruise_Mode;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_Cruise_Mode = 1U;
    ...
    switch (chartInstance->c1_is_c1_Bicycle_SCC_LKS) {
     case c1_IN_Cruise_Mode:
      ...
      if (c1_out) {
        ...
        chartInstance->c1_tp_Cruise_Mode = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
        chartInstance->c1_is_c1_Bicycle_SCC_LKS = c1_IN_FollowUp_Mode;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c1_sfEvent);
        chartInstance->c1_tp_FollowUp_Mode = 1U;
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_Bicycle_SCC_LKSInstanceStruct *chartInstance;
  chartInstance = (SFc1_Bicycle_SCC_LKSInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_Bicycle_SCC_LKS_get_eml_resolved_functions_info(void)
{
...
void sf_c1_Bicycle_SCC_LKS_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_Bicycle_SCC_LKS_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_Bicycle_SCC_LKS_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_Bicycle_SCC_LKS_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_Bicycle_SCC_LKS(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[11],T\"SetSpd\",},{M[3],M[14],T\"TVSpd\",},{M[8],M[0],T\"is_active_c1_Bicycle_SCC_LKS\",},{M[9],M[0],T\"is_c1_Bicycle_SCC_LKS\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_Bicycle_SCC_LKS_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_Bicycle_SCC_LKSInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _Bicycle_SCC_LKSMachineNumber_,
           1,
           2,
           3,
           0,
        ...
        init_script_number_translation(_Bicycle_SCC_LKSMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_Bicycle_SCC_LKSMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _Bicycle_SCC_LKSMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c1_Bicycle_SCC_LKS(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_Bicycle_SCC_LKSInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_Bicycle_SCC_LKS((SFc1_Bicycle_SCC_LKSInstanceStruct*)
    chartInstanceVar);
  initialize_c1_Bicycle_SCC_LKS((SFc1_Bicycle_SCC_LKSInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_Bicycle_SCC_LKS(void *chartInstanceVar)
{
  enable_c1_Bicycle_SCC_LKS((SFc1_Bicycle_SCC_LKSInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_Bicycle_SCC_LKS(void *chartInstanceVar)
{
  disable_c1_Bicycle_SCC_LKS((SFc1_Bicycle_SCC_LKSInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_Bicycle_SCC_LKS(void *chartInstanceVar)
{
  sf_gateway_c1_Bicycle_SCC_LKS((SFc1_Bicycle_SCC_LKSInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_Bicycle_SCC_LKS(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_Bicycle_SCC_LKS
    ((SFc1_Bicycle_SCC_LKSInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_Bicycle_SCC_LKS();/* state var info */
...
extern void sf_internal_set_sim_state_c1_Bicycle_SCC_LKS(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_Bicycle_SCC_LKS();/* state var info */
  ...
  set_sim_state_c1_Bicycle_SCC_LKS((SFc1_Bicycle_SCC_LKSInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_Bicycle_SCC_LKS(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_Bicycle_SCC_LKS(S);
}

static void sf_opaque_set_sim_state_c1_Bicycle_SCC_LKS(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_Bicycle_SCC_LKS(S, st);
}

static void sf_opaque_terminate_c1_Bicycle_SCC_LKS(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_Bicycle_SCC_LKSInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Bicycle_SCC_LKS_optimization_info();
    }

    finalize_c1_Bicycle_SCC_LKS((SFc1_Bicycle_SCC_LKSInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_Bicycle_SCC_LKS((SFc1_Bicycle_SCC_LKSInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_Bicycle_SCC_LKS(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_Bicycle_SCC_LKS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_Bicycle_SCC_LKS_optimization_info();
...
static void mdlRTW_c1_Bicycle_SCC_LKS(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_Bicycle_SCC_LKS(SimStruct *S)
{
  SFc1_Bicycle_SCC_LKSInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_Bicycle_SCC_LKSInstanceStruct *)utMalloc(sizeof
    (SFc1_Bicycle_SCC_LKSInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_Bicycle_SCC_LKSInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_Bicycle_SCC_LKS;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_Bicycle_SCC_LKS;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_Bicycle_SCC_LKS;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_Bicycle_SCC_LKS;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_Bicycle_SCC_LKS;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_Bicycle_SCC_LKS;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_Bicycle_SCC_LKS;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_Bicycle_SCC_LKS;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_Bicycle_SCC_LKS;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_Bicycle_SCC_LKS;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_Bicycle_SCC_LKS;
...
void c1_Bicycle_SCC_LKS_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_Bicycle_SCC_LKS(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_Bicycle_SCC_LKS(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_Bicycle_SCC_LKS(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_Bicycle_SCC_LKS_method_dispatcher.\n"
