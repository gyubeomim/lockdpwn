...
static void initialize_c1_ACC_CarSim(SFc1_ACC_CarSimInstanceStruct
  *chartInstance);
static void initialize_params_c1_ACC_CarSim(SFc1_ACC_CarSimInstanceStruct
  *chartInstance);
static void enable_c1_ACC_CarSim(SFc1_ACC_CarSimInstanceStruct *chartInstance);
static void disable_c1_ACC_CarSim(SFc1_ACC_CarSimInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_ACC_CarSim(SFc1_ACC_CarSimInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_ACC_CarSim(SFc1_ACC_CarSimInstanceStruct *
  chartInstance);
static void set_sim_state_c1_ACC_CarSim(SFc1_ACC_CarSimInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void c1_set_sim_state_side_effects_c1_ACC_CarSim
  (SFc1_ACC_CarSimInstanceStruct *chartInstance);
static void finalize_c1_ACC_CarSim(SFc1_ACC_CarSimInstanceStruct *chartInstance);
static void sf_c1_ACC_CarSim(SFc1_ACC_CarSimInstanceStruct *chartInstance);
static void c1_chartstep_c1_ACC_CarSim(SFc1_ACC_CarSimInstanceStruct
  *chartInstance);
static void initSimStructsc1_ACC_CarSim(SFc1_ACC_CarSimInstanceStruct
  *chartInstance);
static void registerMessagesc1_ACC_CarSim(SFc1_ACC_CarSimInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_ACC_CarSimInstanceStruct *chartInstance,
  const mxArray *c1_nargout, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_ACC_CarSimInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static boolean_T c1_c_emlrt_marshallIn(SFc1_ACC_CarSimInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_d_emlrt_marshallIn(SFc1_ACC_CarSimInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_ACC_CarSimInstanceStruct
  *chartInstance, const mxArray *c1_b_tp_Cruise_Mode, const char_T
  *c1_identifier);
static uint8_T c1_f_emlrt_marshallIn(SFc1_ACC_CarSimInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_g_emlrt_marshallIn(SFc1_ACC_CarSimInstanceStruct
  *chartInstance, const mxArray *c1_b_setSimStateSideEffectsInfo, const char_T
  *c1_identifier);
static const mxArray *c1_h_emlrt_marshallIn(SFc1_ACC_CarSimInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_updateDataWrittenToVector(SFc1_ACC_CarSimInstanceStruct
  *chartInstance, uint32_T c1_vectorIndex);
static void c1_errorIfDataNotWrittenToFcn(SFc1_ACC_CarSimInstanceStruct
  *chartInstance, uint32_T c1_vectorIndex, uint32_T c1_dataNumber);
static void init_dsm_address_info(SFc1_ACC_CarSimInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_ACC_CarSim = 0U;
  chartInstance->c1_is_c1_ACC_CarSim = c1_IN_NO_ACTIVE_CHILD;
}
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_c1_ACC_CarSim == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
  }

  if (chartInstance->c1_is_c1_ACC_CarSim == c1_IN_Cruise_Mode) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
  }

  if (chartInstance->c1_is_c1_ACC_CarSim == c1_IN_FollowUp_Mode) {
  ...
  chartInstance)
{
  ...
  c1_c_hoistedGlobal = chartInstance->c1_is_active_c1_ACC_CarSim;
  c1_c_u = c1_c_hoistedGlobal;
  c1_d_y = NULL;
  sf_mex_assign(&c1_d_y, sf_mex_create("y", &c1_c_u, 3, 0U, 0U, 0U, 0), FALSE);
  sf_mex_setcell(c1_y, 2, c1_d_y);
  c1_d_hoistedGlobal = chartInstance->c1_is_c1_ACC_CarSim;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_SetSpd = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u,
  ...
  chartInstance->c1_is_active_c1_ACC_CarSim = c1_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
     "is_active_c1_ACC_CarSim");
  chartInstance->c1_is_c1_ACC_CarSim = c1_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 3)), "is_c1_ACC_CarSim");
  sf_mex_assign(&chartInstance->c1_setSimStateSideEffectsInfo,
                c1_g_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c1_u, 4)), "setSimStateSideEffectsInfo"), TRUE);
  sf_mex_destroy(&c1_u);
  chartInstance->c1_doSetSimStateSideEffects = 1U;
  c1_update_debugger_state_c1_ACC_CarSim(chartInstance);
...
static void sf_c1_ACC_CarSim(SFc1_ACC_CarSimInstanceStruct *chartInstance)
{
  c1_set_sim_state_side_effects_c1_ACC_CarSim(chartInstance);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_ACC_CarSim(chartInstance);
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_ACC_CarSimMachineNumber_,
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_c1_ACC_CarSim == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_active_c1_ACC_CarSim = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 2U, chartInstance->c1_sfEvent);
    chartInstance->c1_is_c1_ACC_CarSim = c1_IN_Cruise_Mode;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
    chartInstance->c1_tp_Cruise_Mode = 1U;
    ...
    switch (chartInstance->c1_is_c1_ACC_CarSim) {
     case c1_IN_Cruise_Mode:
      ...
      if (c1_out) {
        ...
        chartInstance->c1_tp_Cruise_Mode = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
        chartInstance->c1_is_c1_ACC_CarSim = c1_IN_FollowUp_Mode;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c1_sfEvent);
        chartInstance->c1_tp_FollowUp_Mode = 1U;
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_ACC_CarSimInstanceStruct *chartInstance;
  chartInstance = (SFc1_ACC_CarSimInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_ACC_CarSim_get_eml_resolved_functions_info(void)
{
...
void sf_c1_ACC_CarSim_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_ACC_CarSim_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_ACC_CarSim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c1_ACC_CarSim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[7],T\"SetSpd\",},{M[3],M[10],T\"TVSpd\",},{M[8],M[0],T\"is_active_c1_ACC_CarSim\",},{M[9],M[0],T\"is_c1_ACC_CarSim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_ACC_CarSim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_ACC_CarSimInstanceStruct *chartInstance;
    chartInstance = (SFc1_ACC_CarSimInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_ACC_CarSimMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_ACC_CarSimMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _ACC_CarSimMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c1_ACC_CarSim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_ACC_CarSimInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c1_ACC_CarSim((SFc1_ACC_CarSimInstanceStruct*)
    chartInstanceVar);
  initialize_c1_ACC_CarSim((SFc1_ACC_CarSimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_ACC_CarSim(void *chartInstanceVar)
{
  enable_c1_ACC_CarSim((SFc1_ACC_CarSimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_ACC_CarSim(void *chartInstanceVar)
{
  disable_c1_ACC_CarSim((SFc1_ACC_CarSimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_ACC_CarSim(void *chartInstanceVar)
{
  sf_c1_ACC_CarSim((SFc1_ACC_CarSimInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_ACC_CarSim(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_ACC_CarSim
    ((SFc1_ACC_CarSimInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_ACC_CarSim();/* state var info */
...
extern void sf_internal_set_sim_state_c1_ACC_CarSim(SimStruct* S, const mxArray *
  st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_ACC_CarSim((SFc1_ACC_CarSimInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_ACC_CarSim(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_ACC_CarSim(S);
}

static void sf_opaque_set_sim_state_c1_ACC_CarSim(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c1_ACC_CarSim(S, st);
}

static void sf_opaque_terminate_c1_ACC_CarSim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_ACC_CarSimInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_ACC_CarSim_optimization_info();
    }

    finalize_c1_ACC_CarSim((SFc1_ACC_CarSimInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_ACC_CarSim((SFc1_ACC_CarSimInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_ACC_CarSim(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_ACC_CarSim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_ACC_CarSim_optimization_info();
...
static void mdlRTW_c1_ACC_CarSim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_ACC_CarSim(SimStruct *S)
{
  SFc1_ACC_CarSimInstanceStruct *chartInstance;
  chartInstance = (SFc1_ACC_CarSimInstanceStruct *)utMalloc(sizeof
    (SFc1_ACC_CarSimInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_ACC_CarSimInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_ACC_CarSim;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_ACC_CarSim;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_ACC_CarSim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_ACC_CarSim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_ACC_CarSim;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_ACC_CarSim;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_ACC_CarSim;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_ACC_CarSim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_ACC_CarSim;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_ACC_CarSim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_ACC_CarSim;
...
void c1_ACC_CarSim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_ACC_CarSim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_ACC_CarSim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_ACC_CarSim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_ACC_CarSim_method_dispatcher.\n"
