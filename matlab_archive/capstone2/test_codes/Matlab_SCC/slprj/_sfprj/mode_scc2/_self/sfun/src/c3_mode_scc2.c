...
static void initialize_c3_mode_scc2(SFc3_mode_scc2InstanceStruct *chartInstance);
static void initialize_params_c3_mode_scc2(SFc3_mode_scc2InstanceStruct
  *chartInstance);
static void enable_c3_mode_scc2(SFc3_mode_scc2InstanceStruct *chartInstance);
static void disable_c3_mode_scc2(SFc3_mode_scc2InstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_mode_scc2(SFc3_mode_scc2InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c3_mode_scc2(SFc3_mode_scc2InstanceStruct
  *chartInstance);
static void set_sim_state_c3_mode_scc2(SFc3_mode_scc2InstanceStruct
  *chartInstance, const mxArray *c3_st);
static void c3_set_sim_state_side_effects_c3_mode_scc2
  (SFc3_mode_scc2InstanceStruct *chartInstance);
static void finalize_c3_mode_scc2(SFc3_mode_scc2InstanceStruct *chartInstance);
static void sf_gateway_c3_mode_scc2(SFc3_mode_scc2InstanceStruct *chartInstance);
static void c3_chartstep_c3_mode_scc2(SFc3_mode_scc2InstanceStruct
  *chartInstance);
static void initSimStructsc3_mode_scc2(SFc3_mode_scc2InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_mode_scc2InstanceStruct *chartInstance,
  const mxArray *c3_nargout, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_mode_scc2InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static boolean_T c3_c_emlrt_marshallIn(SFc3_mode_scc2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_mode_scc2InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_mode_scc2InstanceStruct *chartInstance,
  const mxArray *c3_b_tp_Cruise_Mode, const char_T *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_mode_scc2InstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_g_emlrt_marshallIn(SFc3_mode_scc2InstanceStruct
  *chartInstance, const mxArray *c3_b_setSimStateSideEffectsInfo, const char_T
  *c3_identifier);
static const mxArray *c3_h_emlrt_marshallIn(SFc3_mode_scc2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_updateDataWrittenToVector(SFc3_mode_scc2InstanceStruct
  *chartInstance, uint32_T c3_vectorIndex);
static void c3_errorIfDataNotWrittenToFcn(SFc3_mode_scc2InstanceStruct
  *chartInstance, uint32_T c3_vectorIndex, uint32_T c3_dataNumber);
static void init_dsm_address_info(SFc3_mode_scc2InstanceStruct *chartInstance);
...
static void initialize_c3_mode_scc2(SFc3_mode_scc2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_mode_scc2 = 0U;
  chartInstance->c3_is_c3_mode_scc2 = c3_IN_NO_ACTIVE_CHILD;
}
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c3_is_active_c3_mode_scc2 == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
  }

  if (chartInstance->c3_is_c3_mode_scc2 == c3_IN_Cruise_Mode) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
  }

  if (chartInstance->c3_is_c3_mode_scc2 == c3_IN_FollowUp_Mode) {
  ...
  *chartInstance)
{
  ...
  c3_c_hoistedGlobal = chartInstance->c3_is_active_c3_mode_scc2;
  c3_c_u = c3_c_hoistedGlobal;
  c3_d_y = NULL;
  sf_mex_assign(&c3_d_y, sf_mex_create("y", &c3_c_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 2, c3_d_y);
  c3_d_hoistedGlobal = chartInstance->c3_is_c3_mode_scc2;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_SetSpd = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u,
  ...
  chartInstance->c3_is_active_c3_mode_scc2 = c3_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 2)), "is_active_c3_mode_scc2");
  chartInstance->c3_is_c3_mode_scc2 = c3_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 3)), "is_c3_mode_scc2");
  sf_mex_assign(&chartInstance->c3_setSimStateSideEffectsInfo,
                c3_g_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c3_u, 4)), "setSimStateSideEffectsInfo"), true);
  sf_mex_destroy(&c3_u);
  chartInstance->c3_doSetSimStateSideEffects = 1U;
  c3_update_debugger_state_c3_mode_scc2(chartInstance);
...
static void sf_gateway_c3_mode_scc2(SFc3_mode_scc2InstanceStruct *chartInstance)
{
  ...
  c3_set_sim_state_side_effects_c3_mode_scc2(chartInstance);
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_mode_scc2(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_mode_scc2MachineNumber_,
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c3_is_active_c3_mode_scc2 == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, chartInstance->c3_sfEvent);
    chartInstance->c3_is_active_c3_mode_scc2 = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c3_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 2U, chartInstance->c3_sfEvent);
    chartInstance->c3_is_c3_mode_scc2 = c3_IN_Cruise_Mode;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
    chartInstance->c3_tp_Cruise_Mode = 1U;
    ...
    switch (chartInstance->c3_is_c3_mode_scc2) {
     case c3_IN_Cruise_Mode:
      ...
      if (c3_out) {
        ...
        chartInstance->c3_tp_Cruise_Mode = 0U;
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 0U, chartInstance->c3_sfEvent);
        chartInstance->c3_is_c3_mode_scc2 = c3_IN_FollowUp_Mode;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, chartInstance->c3_sfEvent);
        chartInstance->c3_tp_FollowUp_Mode = 1U;
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_mode_scc2InstanceStruct *chartInstance;
  chartInstance = (SFc3_mode_scc2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_mode_scc2_get_eml_resolved_functions_info(void)
{
...
void sf_c3_mode_scc2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_mode_scc2_get_autoinheritance_info(void)
{
...
mxArray *sf_c3_mode_scc2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_mode_scc2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_mode_scc2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[10],T\"SetSpd\",},{M[3],M[14],T\"TVSpd\",},{M[8],M[0],T\"is_active_c3_mode_scc2\",},{M[9],M[0],T\"is_c3_mode_scc2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_mode_scc2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_mode_scc2InstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_mode_scc2MachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_mode_scc2MachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _mode_scc2MachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c3_mode_scc2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_mode_scc2InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c3_mode_scc2((SFc3_mode_scc2InstanceStruct*)
    chartInstanceVar);
  initialize_c3_mode_scc2((SFc3_mode_scc2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_mode_scc2(void *chartInstanceVar)
{
  enable_c3_mode_scc2((SFc3_mode_scc2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_mode_scc2(void *chartInstanceVar)
{
  disable_c3_mode_scc2((SFc3_mode_scc2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_mode_scc2(void *chartInstanceVar)
{
  sf_gateway_c3_mode_scc2((SFc3_mode_scc2InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_mode_scc2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_mode_scc2((SFc3_mode_scc2InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_mode_scc2();/* state var info */
...
extern void sf_internal_set_sim_state_c3_mode_scc2(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_mode_scc2();/* state var info */
  ...
  set_sim_state_c3_mode_scc2((SFc3_mode_scc2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_mode_scc2(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_mode_scc2(S);
}

static void sf_opaque_set_sim_state_c3_mode_scc2(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_mode_scc2(S, st);
}

static void sf_opaque_terminate_c3_mode_scc2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_mode_scc2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_mode_scc2_optimization_info();
    }

    finalize_c3_mode_scc2((SFc3_mode_scc2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_mode_scc2((SFc3_mode_scc2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_mode_scc2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_mode_scc2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_mode_scc2_optimization_info();
...
static void mdlRTW_c3_mode_scc2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_mode_scc2(SimStruct *S)
{
  SFc3_mode_scc2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_mode_scc2InstanceStruct *)utMalloc(sizeof
    (SFc3_mode_scc2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_mode_scc2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_mode_scc2;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c3_mode_scc2;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_mode_scc2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_mode_scc2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_mode_scc2;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c3_mode_scc2;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c3_mode_scc2;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c3_mode_scc2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_mode_scc2;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_mode_scc2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_mode_scc2;
...
void c3_mode_scc2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_mode_scc2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_mode_scc2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_mode_scc2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_mode_scc2_method_dispatcher.\n"
