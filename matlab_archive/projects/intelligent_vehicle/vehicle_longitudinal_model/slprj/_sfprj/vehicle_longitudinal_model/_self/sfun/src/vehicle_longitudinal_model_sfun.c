  ...
  method, void *data)
{
  ...
  if (chartFileNumber==5) {
    c5_vehicle_longitudinal_model_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2336396065U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(603873396U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2311036245U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3766147261U);
      ...
      switch (chartFileNumber) {
       ...
       case 5:
        {
          extern void sf_c5_vehicle_longitudinal_model_get_check_sum(mxArray
            *plhs[]);
          sf_c5_vehicle_longitudinal_model_get_check_sum(plhs);
          break;
        }
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2009608979U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4112572658U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(144248756U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(109551491U);
  }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(aiChksum, "1hLHRjksNSxBuKMfz6zXK") == 0) {
          extern mxArray
     ...
     case 5:
      {
        if (strcmp(aiChksum, "1hLHRjksNSxBuKMfz6zXK") == 0) {
          extern mxArray
            *sf_c5_vehicle_longitudinal_model_get_autoinheritance_info(void);
          plhs[0] = sf_c5_vehicle_longitudinal_model_get_autoinheritance_info();
          break;
        }
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 5:
      {
        extern const mxArray
          *sf_c5_vehicle_longitudinal_model_get_eml_resolved_functions_info(void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c5_vehicle_longitudinal_model_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
  ...
  mxArray * plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "H84Wxqh72bA9wovfxTrCRD") == 0) {
     ...
     case 5:
      {
        if (strcmp(tpChksum, "H84Wxqh72bA9wovfxTrCRD") == 0) {
          extern mxArray *sf_c5_vehicle_longitudinal_model_third_party_uses_info
            (void);
          plhs[0] = sf_c5_vehicle_longitudinal_model_third_party_uses_info();
          break;
        }
      }
     ...
     case 5:
      {
        if (strcmp(tpChksum, "H84Wxqh72bA9wovfxTrCRD") == 0) {
          extern mxArray
            *sf_c5_vehicle_longitudinal_model_updateBuildInfo_args_info(void);
          plhs[0] = sf_c5_vehicle_longitudinal_model_updateBuildInfo_args_info();
          break;
        }
      }
