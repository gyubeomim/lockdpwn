...
#include <stddef.h>
#include "blas.h"
#include "robot_controller2_sfun.h"
#include "c2_robot_controller2.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "robot_controller2_sfun_debug_macros.h"
...
static void initialize_c2_robot_controller2(SFc2_robot_controller2InstanceStruct
  *chartInstance);
static void initialize_params_c2_robot_controller2
  (SFc2_robot_controller2InstanceStruct *chartInstance);
static void enable_c2_robot_controller2(SFc2_robot_controller2InstanceStruct
  *chartInstance);
static void disable_c2_robot_controller2(SFc2_robot_controller2InstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_robot_controller2
  (SFc2_robot_controller2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_robot_controller2
  (SFc2_robot_controller2InstanceStruct *chartInstance);
static void set_sim_state_c2_robot_controller2
  (SFc2_robot_controller2InstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_robot_controller2(SFc2_robot_controller2InstanceStruct
  *chartInstance);
static void sf_gateway_c2_robot_controller2(SFc2_robot_controller2InstanceStruct
  *chartInstance);
static void initSimStructsc2_robot_controller2
  (SFc2_robot_controller2InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_robot_controller2InstanceStruct
  *chartInstance, const mxArray *c2_y, const char_T *c2_identifier, real_T
  c2_b_y[2]);
static void c2_b_emlrt_marshallIn(SFc2_robot_controller2InstanceStruct
...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_robot_controller2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_robot_controller2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[3]);
...
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_robot_controller2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[9]);
...
static void c2_eml_scalar_eg(SFc2_robot_controller2InstanceStruct *chartInstance);
static void c2_eml_xgemm(SFc2_robot_controller2InstanceStruct *chartInstance,
  real_T c2_A[9], real_T c2_B[3], real_T c2_C[3], real_T c2_b_C[3]);
static const mxArray *c2_f_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_f_emlrt_marshallIn(SFc2_robot_controller2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_g_emlrt_marshallIn(SFc2_robot_controller2InstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_robot_controller2, const
  char_T *c2_identifier);
static uint8_T c2_h_emlrt_marshallIn(SFc2_robot_controller2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_eml_xgemm(SFc2_robot_controller2InstanceStruct *chartInstance,
  real_T c2_A[9], real_T c2_B[3], real_T c2_C[3]);
static void init_dsm_address_info(SFc2_robot_controller2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_robot_controller2 = 0U;
}
  ...
  (SFc2_robot_controller2InstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_robot_controller2;
  ...
  (SFc2_robot_controller2InstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_robot_controller2 = c2_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_robot_controller2");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_robot_controller2(chartInstance);
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_robot_controller2MachineNumber_,
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_robot_controller2InstanceStruct *chartInstance;
  chartInstance = (SFc2_robot_controller2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_robot_controller2_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_robot_controller2), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_robot_controller2);
  return c2_y;
}
...
void sf_c2_robot_controller2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_robot_controller2_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_robot_controller2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_robot_controller2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_robot_controller2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_robot_controller2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_robot_controller2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_robot_controller2InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_robot_controller2MachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_robot_controller2MachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _robot_controller2MachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c2_robot_controller2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_robot_controller2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_robot_controller2((SFc2_robot_controller2InstanceStruct*)
    chartInstanceVar);
  initialize_c2_robot_controller2((SFc2_robot_controller2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_robot_controller2(void *chartInstanceVar)
{
  enable_c2_robot_controller2((SFc2_robot_controller2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_robot_controller2(void *chartInstanceVar)
{
  disable_c2_robot_controller2((SFc2_robot_controller2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_robot_controller2(void *chartInstanceVar)
{
  sf_gateway_c2_robot_controller2((SFc2_robot_controller2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_robot_controller2(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_robot_controller2
    ((SFc2_robot_controller2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_robot_controller2();/* state var info */
...
extern void sf_internal_set_sim_state_c2_robot_controller2(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_robot_controller2();/* state var info */
  ...
  set_sim_state_c2_robot_controller2((SFc2_robot_controller2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_robot_controller2(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_robot_controller2(S);
}

static void sf_opaque_set_sim_state_c2_robot_controller2(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_robot_controller2(S, st);
}

static void sf_opaque_terminate_c2_robot_controller2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_robot_controller2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_robot_controller2_optimization_info();
    }

    finalize_c2_robot_controller2((SFc2_robot_controller2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_robot_controller2((SFc2_robot_controller2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_robot_controller2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_robot_controller2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_robot_controller2_optimization_info();
...
static void mdlRTW_c2_robot_controller2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_robot_controller2(SimStruct *S)
{
  SFc2_robot_controller2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_robot_controller2InstanceStruct *)utMalloc(sizeof
    (SFc2_robot_controller2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_robot_controller2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_robot_controller2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_robot_controller2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_robot_controller2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_robot_controller2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_robot_controller2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_robot_controller2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_robot_controller2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_robot_controller2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_robot_controller2;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_robot_controller2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_robot_controller2;
...
void c2_robot_controller2_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_robot_controller2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_robot_controller2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_robot_controller2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_robot_controller2_method_dispatcher.\n"
