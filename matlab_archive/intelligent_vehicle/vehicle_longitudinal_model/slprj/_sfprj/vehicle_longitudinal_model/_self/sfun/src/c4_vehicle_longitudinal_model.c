...
static real_T c4_emlrt_marshallIn(SFc4_vehicle_longitudinal_modelInstanceStruct *
  chartInstance, const mxArray *c4_sign, const char_T *c4_identifier);
  ...
  (SFc4_vehicle_longitudinal_modelInstanceStruct *chartInstance)
{
  ...
  real_T *c4_sign;
  c4_sign = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c4_st = NULL;
  c4_st = NULL;
  c4_y = NULL;
  sf_mex_assign(&c4_y, sf_mex_createcellarray(2), FALSE);
  c4_hoistedGlobal = *c4_sign;
   ...
   *c4_st)
{
  ...
  *c4_sign = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u,
    0)), "sign");
...
{
  real_T c4_hoistedGlobal;
  real_T c4_slip_ratio;
  uint32_T c4_debug_family_var_map[4];
  real_T c4_nargin = 1.0;
  real_T c4_nargout = 1.0;
  real_T c4_sign;
  real_T *c4_b_slip_ratio;
  real_T *c4_b_sign;
  c4_b_sign = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c4_b_slip_ratio = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 3U, chartInstance->c4_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c4_b_slip_ratio, 0U);
  _SFD_DATA_RANGE_CHECK(*c4_b_sign, 1U);
  chartInstance->c4_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 3U, chartInstance->c4_sfEvent);
  c4_hoistedGlobal = *c4_b_slip_ratio;
  c4_slip_ratio = c4_hoistedGlobal;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_nargout, 1U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_slip_ratio, 2U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_sign, 3U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 3);
  c4_sign = 1.0;
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 5);
  if (CV_EML_IF(0, 1, 0, c4_slip_ratio >= -0.1)) {
    _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 6);
    c4_sign = 1.0;
  } else {
    _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 7);
    if (CV_EML_IF(0, 1, 1, c4_slip_ratio <= -0.3)) {
  ...
  chartInstance, const mxArray *c4_sign, const char_T *c4_identifier)
{
  ...
  c4_y = c4_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_sign), &c4_thisId);
  sf_mex_destroy(&c4_sign);
  return c4_y;
}
  ...
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData)
{
  ...
  chartInstance = (SFc4_vehicle_longitudinal_modelInstanceStruct *)
    chartInstanceVoid;
  c4_sign = sf_mex_dup(c4_mxArrayInData);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(168472018U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3911013153U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1008301103U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1339003429U);
}
...
mxArray *sf_c4_vehicle_longitudinal_model_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Xrzq89eJhlAwugf3r9zyHH");
...
static const mxArray *sf_get_sim_state_info_c4_vehicle_longitudinal_model(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"sign\",},{M[8],M[0],T\"is_active_c4_vehicle_longitudinal_model\",}}"
  };
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,53,74,89,114);
        _SFD_CV_INIT_EML_IF(0,1,1,89,114,-1,114);
...

        {
          ...
          real_T *c4_sign;
          c4_sign = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c4_slip_ratio = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c4_slip_ratio);
          _SFD_SET_DATA_VALUE_PTR(1U, c4_sign);
        }
      }
    } else {
...
static void mdlSetWorkWidths_c4_vehicle_longitudinal_model(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3281342812U));
  ssSetChecksum1(S,(173453882U));
  ssSetChecksum2(S,(2990846682U));
  ssSetChecksum3(S,(825880348U));
