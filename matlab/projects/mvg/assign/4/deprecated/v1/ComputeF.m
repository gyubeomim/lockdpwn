function [F, x1_best, x2_best, epi_inliers] = ComputeF(x1, x2, customIdx)
    ...
    for i = 1:ransac_iter
        ...
        x1_sampled = x1(idx, :); % Dim.: 8x2
        x2_sampled = x2(idx, :); % Dim.: 8x2
    ...
    %customIdx = [1,2,3,4,9,11,13,15];
%     x1_best = x1(customIdx,:);
%     x2_best = x2(customIdx,:);
